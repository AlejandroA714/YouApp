package com.bytesw.tyu.bi.web.client.services;

import com.bytesw.tyu.bi.web.client.interfaces.DefaultResponseSpec;
import com.bytesw.tyu.bi.web.client.interfaces.ResponseDesc;
...
public interface WebClientService {
    ...
    <T extends Serializable, B extends Serializable> Mono<T> deleteRequest(
            String baseUrl, String path, Class<T> tClass,
            WebClientHeader header, WebClientParameter param);

    <B extends Serializable> Mono<Void> deleteRequestVoid(String baseUrl,
            String path, WebClientHeader[] headers,
    ...
    default <T extends Serializable> ResponseDesc doGetRequest(String baseUrl,
            String path, WebClientParameter[] params,
            WebClientHeader... headers) {
    ...
    default <T extends Serializable> ResponseDesc doDeleteRequest(
            String baseUrl, String path, WebClientParameter[] params,
            WebClientHeader... headers) {
    ...
    default Consumer<HttpHeaders> requestHeadersSpec(
        ...
        return httpHeaders -> {
            ...
            getLogger().info("Se crearon los siguientes headers: {}",
                    httpHeaders);
        };
    }
