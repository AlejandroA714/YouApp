...
public class DefaultWebClientService implements WebClientService {
    ...
    public <T extends Serializable> Flux<T> getRequest(String baseUrl,
        ...
        return this.doGetRequest(baseUrl, path, null, headers)
                .bodyToFlux(tClass);
    }
    ...
    public <T extends Serializable> Flux<T> getRequest(String baseUrl,
        ...
        return this.doGetRequest(baseUrl, path, params, null)
                .bodyToFlux(tClass);
    }
    ...
    public <T extends Serializable> Flux<T> getRequest(String baseUrl,
        ...
        return this
                .doGetRequest(baseUrl, path,
                        new WebClientParameter[] { params }, header)
                .bodyToFlux(tClass);
    }
    ...
    public <T extends Serializable, B extends Serializable> Mono<T> putRequest(
            String baseUrl, String path, Collection<B> body, Class<T> tClass,
            WebClientHeader... headers) {
        return this.doPutRequest(baseUrl, path, body, headers)
                .bodyToMono(tClass);
    }
    ...
    public <T extends Serializable> Mono<T> deleteRequest(String baseUrl,
            String path, Class<T> tClass) {
        return this.doDeleteRequest(baseUrl, path, null, null)
                .bodyToMono(tClass);
    }
    ...
    public <T extends Serializable, B extends Serializable> Mono<T> deleteRequest(
        ...
        return this
                .doDeleteRequest(baseUrl, path,
                        new WebClientParameter[] { param }, header)
                .bodyToMono(tClass);
    }
