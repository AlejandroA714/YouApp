...
public class OicdTokenMetadataEntity {
   @Id
   ...
   public static OicdTokenMetadataEntity create(Map<String, Object> payload) {
      var claims = (Map<String, Object>) payload.get(CLAIMS_METADATA_NAME);
      return OicdTokenMetadataEntity.builder().sub(getSettings(claims, SUB))
