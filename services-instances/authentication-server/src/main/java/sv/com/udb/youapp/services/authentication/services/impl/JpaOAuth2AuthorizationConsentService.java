...
import sv.com.udb.youapp.services.authentication.repositories.AuthorizationConsentRepository;
...
public class JpaOAuth2AuthorizationConsentService
   ...
   public void save(OAuth2AuthorizationConsent authorizationConsent) {
      Assert.notNull(authorizationConsent,
            "authorizationConsent cannot be null");
   ...
   public OAuth2AuthorizationConsent findById(String registeredClientId,
      ...
      return this.authorizationConsentRepository
            .findByRegisteredClientIdAndPrincipalName(registeredClientId,
                  principalName)
            .map(this::toObject).orElse(null);
   }

   private OAuth2AuthorizationConsent toObject(
         AuthorizationConsentEntity authorizationConsent) {
   ...
   private AuthorizationConsentEntity toEntity(
